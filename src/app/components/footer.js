            ...
            <div className="w-full lg:w-6/12 px-4">
              <div className="flex flex-wrap items-top mb-6">
                ...
                <div className="w-full lg:w-4/12 px-4 ">
                  <span className="block uppercase text-blueGray-500 text-sm font-semibold mb-2 md:block">
                    Other Resources
                  </span>
            ...
            <div className="w-full md:w-4/12 px-4 mx-auto text-center">
              <div className="flex justify-center items-center text-sm text-blueGray-500 font-semibold py-1 whitespace-nowrap">
                ...
                <a
                  ...
                  className="flex justify-center items-center text-blueGray-500 hover:text-gray-800"
                  target="_blank"
                  whitespace-nowrap
                >
                  {" "}
          ...
          <div className="flex flex-col items-center">
            <div className="mb-4 flex justify-center items-center">
              <Image
                ...
                height={50}
              />
              <h4 className="text-3xl font-extrabold text-white whitespace-nowrap">
                PG-AGI
              </h4>
            </div>
            ...
            <div className="mb-6 flex justify-center items-center">
              <a
                href="https://twitter.com/PGAGI123"
                className="mr-3 flex h-10 w-10 items-center justify-center rounded-full border border-stroke  hover:border-white hover:bg-white hover:text-white lg:mr-3 xl:mr-4"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
            ...
            <span className="block uppercase text-gray-500 text-sm font-semibold mb-2 whitespace-nowrap">
              Useful Links
            </span>
            <ul className="list-unstyled">
              <li>
              ...
              <li>
                <a
                  className=" text-white hover:text-blueGray-800 font-semibold block pb-2 text-sm whitespace-nowrap"
                  href="https://github.com/PG-AGI"
                >
                  Github
                </a>

...
const Footer = () => {
  return (
    <>
      <footer className="relative bg-gray-900 text-white pt-8 pb-6 w-full md:text-center ">
        <div className="container mx-auto px-4 pl-[12rem] pr-[12rem] hidden sm:block">
          <div className="flex flex-wrap text-left lg:text-left">
            <div className="w-full lg:w-6/12 px-4">
              <div className="grid items-center">
                <Image
                  ...
                  height={80}
                />
                <h4 className="text-xl font-extrabold text-white whitespace-nowrap">
                  PG-AGI
                </h4>
              </div>
              <h5 className="text-md mt-6 mb-5 text-white whitespace-nowrap">
                Find us on any of these platforms
              </h5>
              <div className="mb-6 flex items-center ">
                <a
                  href="https://twitter.com/PGAGI123"
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-stroke hover:border-blue-500 hover:bg-blue-500 hover:text-white mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
            ...
            h6l21.3-22.8L48,66h20L42.5,31.2z M12.9,10h8l38.1,52h-8L12.9,10z"
                ...
                <a
                  ...
                  className="mr-3 flex h-10 w-10 items-center justify-center rounded-full border border-stroke hover:border-blue-500 hover:bg-blue-500 hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width="16"
                    height="12"
            ...
            <div className="w-full lg:w-6/12 px-4">
              <div className="flex flex-wrap items-top mb-6">
                <div className="w-full lg:w-4/12 px-4 ml-auto">
                  <span className="block uppercase text-gray-400 text-sm font-semibold mb-2 whitespace-nowrap">
                    Useful Links
                  </span>
                  <ul className="list-unstyled">
                    <li>
                      <Link
                        href="/aboutus"
                        className="text-blueGray-600 hover:text-blue-500 font-semibold block pb-2 text-sm whitespace-nowrap"
                      >
                        About Us
                      </Link>
                    </li>
                    ...
                    <li>
                      <a className="text-blueGray-600 hover:text-blue-500 font-semibold block pb-2 text-sm whitespace-nowrap">
                        Blog
                      </a>
                    </li>
                    <li>
                ...
                <div className="w-full lg:w-4/12 px-4 ">
                  <span className="block uppercase text-gray-400 text-sm font-semibold mb-2 md:block">
                    Other Resources
                  </span>
                  <ul className="list-unstyled hidden md:block">
                    <li>
                      <a className="text-blueGray-600 hover:text-blue-500 font-semibold block pb-2 text-sm">
                        MIT License
                      </a>
                    </li>
                    <li>
            ...
            <div className="w-full md:w-4/12 px-4 mx-auto text-center">
              <div className="flex justify-center items-center text-sm text-blueGray-500 font-semibold py-1 whitespace-nowrap">
                ...
                <a
                  ...
                  className="flex justify-center items-center text-blueGray-500 hover:text-blue-500"
                  target="_blank"
                  whitespace-nowrap
                >
                  {" "}
